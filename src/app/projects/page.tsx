...
const CategoryButton: React.FC<{
  ...
  return (
    <motion.button
      ...
      className={`category-button px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-blue-500 ${isSelected ? 'bg-blue-500 text-white' : 'bg-sky-700 dark:bg-gray-700 text-gray-900 dark:text-gray-200'
        }`}
